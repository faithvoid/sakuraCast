# sakuraCast
Chromecast casting program written in Python using PyChromecast, with focus on custom aspect ratio support (ie; for casting 4:3 content properly on 4:3 devices). 
...
- Open it and select your video file(s) or enter your video URL (file with extension or YouTube only!)
